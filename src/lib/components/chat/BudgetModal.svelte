<script lang="ts">
	...
	$: budgetLabel = `$ ${maxBudget.toLocaleString('de-DE', { minimumFractionDigits: 2, maximumFractionDigits: 4 })} / $ ${spend.toLocaleString('de-DE', { minimumFractionDigits: 2, maximumFractionDigits: 4 })}`;
