...
export const createNewProject = async (token: string, project: object) => {
	let error = null;
...
export const getProjects = async (token: string = '', share?: boolean) => {
	let error = null;
...
export const getProjectById = async (token: string, id: string) => {
	...
	const res = await fetch(`${WEBUI_API_BASE_URL}/projects/id/${id}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getProjectInfoById = async (token: string, id: string) => {
	let error = null;

	const res = await fetch(`${WEBUI_API_BASE_URL}/projects/id/${id}/info`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateProjectById = async (token: string, id: string, project: object) => {
	let error = null;

	const res = await fetch(`${WEBUI_API_BASE_URL}/projects/id/${id}/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const deleteProjectById = async (token: string, id: string) => {
	...
	const res = await fetch(`${WEBUI_API_BASE_URL}/projects/id/${id}/delete`, {
		method: 'DELETE',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const addUserToProject = async (token: string, id: string, userIds: string[]) => {
	let error = null;

	const res = await fetch(`${WEBUI_API_BASE_URL}/projects/id/${id}/users/add`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const removeUserFromProject = async (token: string, id: string, userIds: string[]) => {
	let error = null;

	const res = await fetch(`${WEBUI_API_BASE_URL}/projects/id/${id}/users/remove`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
