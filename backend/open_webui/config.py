...
ENABLE_LDAP_PROJECT_MANAGEMENT = os.getenv('ENABLE_LDAP_PROJECT_MANAGEMENT', 'False').lower() == 'true'

ENABLE_LDAP_PROJECT_CREATION = os.getenv('ENABLE_LDAP_PROJECT_CREATION', 'False').lower() == 'true'

LDAP_ATTRIBUTE_FOR_PROJECTS = os.getenv('LDAP_ATTRIBUTE_FOR_PROJECTS', 'memberOf')
